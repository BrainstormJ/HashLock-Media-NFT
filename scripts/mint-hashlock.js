// scripts/mint.js
/**
 * Script to mint a HashLock Media NFT
 *
 * Usage:
...
async function main() {
  ...
  console.log("🎨 Starting HashLock Media NFT minting process...\n");
  ...
  console.log("📡 Connecting to HashLockMediaNFT at:", CONTRACT_ADDRESS);
  const HashLockMediaNFT = await hre.ethers.getContractFactory("HashLockMediaNFT");
  const contract = HashLockMediaNFT.attach(CONTRACT_ADDRESS);
  ...
  /*
  {
    ...
    "image": "ipfs://QmImageHash/media-thumbnail.jpg",
  ...
  */
  ...
  try {
    ...
    const mintEvent = receipt.logs.find(
      log => log.fragment && log.fragment.name === "MediaLicenseMinted"
    );

    if (mintEvent) {
      const tokenId = mintEvent.args.tokenId;
      console.log("\n🎉 HashLock Media NFT Minted Successfully!");
...
async function batchMint() {
  ...
  console.log("🎨 Starting HashLock Media NFT batch minting...\n");
